                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-4 col-lg-4 col-sm-6 col-12">
                      <div class="">
                        <h5 class="app-sub-heading">Mailing Configurations</h5>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                      <div class="">
                        <h5 class="app-sub-heading">Payment Gateway Setup</h5>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                      <div class="">
                        <h5 class="app-sub-heading">Enable & Disable features</h5>
                        <form class="form row" action="../../controller/configcontroller.php" method="POST">
                          <?php FormPrimaryInputs(true); ?>
                          <div class="form-group form-group-2 col-md-12">
