                    ...
                    if ($Complaints == null) {
                      ...
                      foreach ($Complaints as $Complaint) {
                        ...
                        <tr>
                          <td><?PHP echo $sNO; ?></td>
                          <td>
                            <a href="complaint-detials.php?id=<?php echo $Complaint->ComplaintsId; ?>" class="bold"><?php echo $Complaint->ComplaintsCustomRefId; ?></a>
                          </td>
                          <td>
                          ...
                          <td>
                            <a href="complaint-detials.php?id=<?php echo $Complaint->ComplaintsId; ?>" class="btn btn-xs btn-primary">Details</a>
                          </td>
                        </tr>
                    <?php }
                    } ?>
