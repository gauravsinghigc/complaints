      ...
      <div class="row mt-4">
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            if (isset($_GET['type'])) {
              $type = $_GET['type'];
              $Complaints = FetchConvertIntoArray("SELECT * FROM complaints where ComplaintAssignedTo='' and ComplaintStatus like '%$type%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
            } elseif (isset($_GET['ComplaintsCustomRefId'])) {
              $ComplaintsCustomRefId = $_GET['ComplaintsCustomRefId'];
              $Complaints = FetchConvertIntoArray("SELECT * FROM complaints where ComplaintAssignedTo='' and ComplaintsCustomRefId like '%$ComplaintsCustomRefId%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
            } else {
              $Complaints = FetchConvertIntoArray("SELECT * FROM complaints where ComplaintAssignedTo='' and ComplaintStatus like '%NEW COMPLAINT%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
            }
