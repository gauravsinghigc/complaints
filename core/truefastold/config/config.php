...
define("LOCAL_HOST", array("127.0.0.1", "::1", "localhost", "192.168.1.9", "192.168.43.14", "192.168.1.10", "192.168.27.206"));

//filter domain from local or live server
if (in_array("" . HOST . "", LOCAL_HOST)) {
  define("DOMAIN", $link . HOST . "/projects/truefast");
} else {
...
define("USER_ROLES", array("ADMIN", "USERS", "CUSTOMERS"));
