  ...
  <div id="app" class="app app-content-full-height app-header-fixed app-sidebar-fixed">
    ...
    <div id="content" class="app-content">
      ...
      <div class="d-flex align-items-center mb-1">
        ...
        <div class="ms-auto">
          <a href="add.php" class="btn btn-success btn-rounded px-4 rounded-pill"><i class="fa fa-plus fa-lg me-2 ms-n2 text-white"></i> Add Products</a>
          <a href="upload.php" class="btn btn-primary btn-rounded px-4 rounded-pill"><i class="fa fa-upload fa-lg me-2 ms-n2 text-white"></i> Upload Products</a>
        </div>
      </div>
          ...
          if ($Products != null) {
            ...
            foreach ($Products as $Data) {
              ...
              <tr>
                ...
                <td>
                  <a href="details/index.php?proid=<?php echo $Data->ProductID; ?>" class="btn btn-xs btn-primary">View Details</a>
                  <a href="add-stock.php?proid=<?php echo $Data->ProductID; ?>" class="btn btn-xs btn-success">Add Stock</a>
                  <?php if ($StockCount == 0) {
